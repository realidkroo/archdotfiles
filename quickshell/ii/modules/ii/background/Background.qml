...
import qs.modules.ii.background.widgets.mac
    ...
    PanelWindow {
        ...
        Item {
            ...
            WidgetCanvas {
                ...
                FadeLoader {
                    shown: Config.options.background.widgets.macClock.enable
                    sourceComponent: MacClockWidget {
                        screenWidth: bgRoot.screen.width
                        screenHeight: bgRoot.screen.height
                        scaledScreenWidth: bgRoot.screen.width / bgRoot.effectiveWallpaperScale
                        scaledScreenHeight: bgRoot.screen.height / bgRoot.effectiveWallpaperScale
                ...
                FadeLoader {
                    shown: Config.options.background.widgets.macDate.enable
                    sourceComponent: MacDateWidget {
                        screenWidth: bgRoot.screen.width
                        screenHeight: bgRoot.screen.height
                        scaledScreenWidth: bgRoot.screen.width / bgRoot.effectiveWallpaperScale
                        scaledScreenHeight: bgRoot.screen.height / bgRoot.effectiveWallpaperScale
                ...
                FadeLoader {
                    shown: Config.options.background.widgets.macWeather.enable
                    sourceComponent: MacWeatherWidget {
                        screenWidth: bgRoot.screen.width
                        screenHeight: bgRoot.screen.height
                        scaledScreenWidth: bgRoot.screen.width / bgRoot.effectiveWallpaperScale
                        scaledScreenHeight: bgRoot.screen.height / bgRoot.effectiveWallpaperScale
