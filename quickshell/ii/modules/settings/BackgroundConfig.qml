...
ContentPage {
    ...
    ContentSection {
        icon: "schedule"
        title: Translation.tr("Widget: Mac Clock")
        ...
        ConfigRow {
            ...
            ConfigSwitch {
                ...
                buttonIcon: "check"
                text: Translation.tr("Enable")
                checked: Config.options.background.widgets.macClock.enable
                onCheckedChanged: {
                    Config.options.background.widgets.macClock.enable = checked;
                }
            }
            Item {
                Layout.fillWidth: true
            ...
            ConfigSelectionArray {
                Layout.fillWidth: false
                currentValue: Config.options.background.widgets.macClock.placementStrategy
                onSelected: newValue => {
                    Config.options.background.widgets.macClock.placementStrategy = newValue;
                }
                options: [
                    {
                        displayName: Translation.tr("Draggable"),
        ...
        ConfigSwitch {
            ...
            checked: Config.options.background.widgets.macClock.showOnLockScreen
            onCheckedChanged: {
                Config.options.background.widgets.macClock.showOnLockScreen = checked;
            }
        }
    }
    ...
    ContentSection {
        icon: "calendar_today"
        title: Translation.tr("Widget: Mac Date")
        ...
        ConfigRow {
            ...
            ConfigSwitch {
                ...
                buttonIcon: "check"
                text: Translation.tr("Enable")
                checked: Config.options.background.widgets.macDate.enable
                onCheckedChanged: {
                    Config.options.background.widgets.macDate.enable = checked;
                }
            }
            Item {
                Layout.fillWidth: true
            ...
            ConfigSelectionArray {
                Layout.fillWidth: false
                currentValue: Config.options.background.widgets.macDate.placementStrategy
                onSelected: newValue => {
                    Config.options.background.widgets.macDate.placementStrategy = newValue;
                }
                options: [
                    {
                        displayName: Translation.tr("Draggable"),
        ...
        ConfigSwitch {
            buttonIcon: "lock_clock"
            text: Translation.tr("Show on lock screen")
            checked: Config.options.background.widgets.macDate.showOnLockScreen
            onCheckedChanged: {
                Config.options.background.widgets.macDate.showOnLockScreen = checked;
            }
        }
    }
    ...
    ContentSection {
        ...
        title: Translation.tr("Widget: Mac Weather")
        ...
        ConfigRow {
            ...
            ConfigSwitch {
                ...
                buttonIcon: "check"
                text: Translation.tr("Enable")
                checked: Config.options.background.widgets.macWeather.enable
                onCheckedChanged: {
                    Config.options.background.widgets.macWeather.enable = checked;
                }
            }
            Item {
                Layout.fillWidth: true
            ...
            ConfigSelectionArray {
                Layout.fillWidth: false
                currentValue: Config.options.background.widgets.macWeather.placementStrategy
                onSelected: newValue => {
                    Config.options.background.widgets.macWeather.placementStrategy = newValue;
                }
                options: [
                    {
                        displayName: Translation.tr("Draggable"),
        ...
        ConfigSwitch {
            buttonIcon: "lock_clock"
            text: Translation.tr("Show on lock screen")
            checked: Config.options.background.widgets.macWeather.showOnLockScreen
            onCheckedChanged: {
                Config.options.background.widgets.macWeather.showOnLockScreen = checked;
            }
        }
    }
}
