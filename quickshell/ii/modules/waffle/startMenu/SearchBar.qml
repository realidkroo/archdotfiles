...
FooterRectangle {
    ...
    // Animate padding when searching to visually expand the search bar
    onSearchingChanged: {
        if (Config.options.waffles.tweaks.smootherSearchBar) {
            horizontalPadding = searching ? 12 : 32;
            verticalPadding = searching ? 12 : 16;
        } else {
            horizontalPadding = searching ? 12 : 32;
            verticalPadding = searching ? 12 : 16;
        }
